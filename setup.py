...
plugin_requires = ["pyheatshrink==dev","pyserial>=3.5","marlin-binary-protocol>=0.0.7"]
...
additional_setup_parameters = {"dependency_links": ["https://github.com/p3p/pyheatshrink/releases/download/0.3.3/pyheatshrink-pip.zip#egg=pyheatshrink-dev"]}
